...
public class SearchArticlesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get the strings that will be passed as param for the request
        ...
        String keywordRequest = "headline:(\""+ preferences.getString(KEYWORD_SEARCH, null) +"\")";
    ...
    //-----------------------
    /**
     * if no article is found, then we display an alertDialog to inform the user
     */
